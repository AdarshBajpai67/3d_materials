...
router.post('/materials',upload.single('image'),materialController.createMaterial)  //Add a new material to the database, including an image upload
...
router.put('/materials/:id',upload.single('image'),materialController.updateMaterial)  //Update an existing material's details, optionally updating its associated image
